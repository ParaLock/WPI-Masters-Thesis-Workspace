...
import main.renderer.ShaderSPIRVUtils.SPIRV;
import org.joml.*;
...
import static main.renderer.AlignmentUtils.alignas;
import static main.renderer.AlignmentUtils.alignof;
import static main.renderer.ShaderSPIRVUtils.ShaderKind.FRAGMENT_SHADER;
import static main.renderer.ShaderSPIRVUtils.ShaderKind.VERTEX_SHADER;
import static main.renderer.ShaderSPIRVUtils.compileShaderFile;
...
public class TriangleMain {
    ...
    private static class ApplicationMain {
        ...
        private void populateDebugMessengerCreateInfo(VkDebugUtilsMessengerCreateInfoEXT debugCreateInfo) {
            ...
            debugCreateInfo.pfnUserCallback(ApplicationMain::debugCallback);
        }
